<?php include "session_check.php";
	if(isset($_SESSION['prevPage']) && isset($_SESSION['currentPage'])) {
		...
		$_SESSION['prevPage'] =  "pie_page.php";
	}
$_SESSION['currentPage'] = "pie_page.php";?>
...
<html lang="eng">
	...
	<body>
        ...
        ?>
		<section>
			<h1>Selection of Pies...</h1>
			<ul>
				<li class="list active" data-filter="all">All</li>
				<li class="list" data-filter="blueberry">Blueberry</li>
				<li class="list" data-filter="keylime">KeyLime</li>
			</ul>
			<div class="product">
				<div class="itemBox blueberry">
					<h2>Blueberry Pie</h2>
					<a href="blueberry_pie_item.php"><img src="blueberry_pie.jpg"></a>
				</div>
				<div class="itemBox keylime">
					<h2>Keylime Pie</h2>
